...
public class SDKServiceBindingStub extends Stub implements SDKClient {
    ...
    public SDKServiceBindingStub() throws AxisFault {
         this(null);
    }

    public SDKServiceBindingStub(java.net.URL endpointURL, javax.xml.rpc.Service service) throws AxisFault {
         this(service);
         super.cachedEndpoint = endpointURL;
    }

    @SuppressWarnings({ "unchecked", "unused" })
	public SDKServiceBindingStub(javax.xml.rpc.Service service) throws AxisFault {
        if (service == null) {
