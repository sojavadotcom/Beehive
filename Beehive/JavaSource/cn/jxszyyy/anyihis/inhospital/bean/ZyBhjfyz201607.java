...
/**
 * The persistent class for the ZY_BHJFYZ201607 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201607", schema="HIS")
@NamedQuery(name="ZyBhjfyz201607.findAll", query="SELECT z FROM ZyBhjfyz201607 z")
public class ZyBhjfyz201607 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = -1752594278882324900L;
