...
/**
 * The persistent class for the ZY_BHJFYZ201606 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201606", schema="HIS")
@NamedQuery(name="ZyBhjfyz201606.findAll", query="SELECT z FROM ZyBhjfyz201606 z")
public class ZyBhjfyz201606 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = -7416929280696551091L;
