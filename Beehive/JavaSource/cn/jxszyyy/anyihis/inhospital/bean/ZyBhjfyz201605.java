...
/**
 * The persistent class for the ZY_BHJFYZ201605 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201605", schema="HIS")
@NamedQuery(name="ZyBhjfyz201605.findAll", query="SELECT z FROM ZyBhjfyz201605 z")
public class ZyBhjfyz201605 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 6551807024448011344L;
