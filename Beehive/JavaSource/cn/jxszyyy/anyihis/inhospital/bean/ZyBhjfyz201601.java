...
/**
 * The persistent class for the ZY_BHJFYZ201601 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201601", schema="HIS")
@NamedQuery(name="ZyBhjfyz201601.findAll", query="SELECT z FROM ZyBhjfyz201601 z")
public class ZyBhjfyz201601 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 1099315401918627924L;
