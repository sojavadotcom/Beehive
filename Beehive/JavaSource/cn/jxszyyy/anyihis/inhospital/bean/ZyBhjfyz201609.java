...
/**
 * The persistent class for the ZY_BHJFYZ201609 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201609", schema="HIS")
@NamedQuery(name="ZyBhjfyz201609.findAll", query="SELECT z FROM ZyBhjfyz201609 z")
public class ZyBhjfyz201609 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = -1979051961677835848L;
