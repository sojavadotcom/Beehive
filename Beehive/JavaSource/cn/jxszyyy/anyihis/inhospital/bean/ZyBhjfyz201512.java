...
/**
 * The persistent class for the ZY_BHJFYZ201512 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201512", schema="HIS")
@NamedQuery(name="ZyBhjfyz201512.findAll", query="SELECT z FROM ZyBhjfyz201512 z")
public class ZyBhjfyz201512 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 1376179451973424199L;
