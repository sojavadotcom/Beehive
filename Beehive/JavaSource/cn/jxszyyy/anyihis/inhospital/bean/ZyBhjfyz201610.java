...
/**
 * The persistent class for the ZY_BHJFYZ201610 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201610", schema="HIS")
@NamedQuery(name="ZyBhjfyz201610.findAll", query="SELECT z FROM ZyBhjfyz201610 z")
public class ZyBhjfyz201610 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 310490283257261270L;
