...
/**
 * The persistent class for the ZY_BHJFYZ201603 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201603", schema="HIS")
@NamedQuery(name="ZyBhjfyz201603.findAll", query="SELECT z FROM ZyBhjfyz201603 z")
public class ZyBhjfyz201603 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 3973830920976716073L;
