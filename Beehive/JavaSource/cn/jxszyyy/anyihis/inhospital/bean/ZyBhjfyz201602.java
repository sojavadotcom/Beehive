...
/**
 * The persistent class for the ZY_BHJFYZ201602 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201602", schema="HIS")
@NamedQuery(name="ZyBhjfyz201602.findAll", query="SELECT z FROM ZyBhjfyz201602 z")
public class ZyBhjfyz201602 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 669838119372293391L;
