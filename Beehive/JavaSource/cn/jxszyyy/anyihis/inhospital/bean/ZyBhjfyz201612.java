...
/**
 * The persistent class for the ZY_BHJFYZ201612 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201612", schema="HIS")
@NamedQuery(name="ZyBhjfyz201612.findAll", query="SELECT z FROM ZyBhjfyz201612 z")
public class ZyBhjfyz201612 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 9201965657744160849L;
