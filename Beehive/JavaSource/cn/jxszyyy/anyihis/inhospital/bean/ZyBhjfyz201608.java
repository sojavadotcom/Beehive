...
/**
 * The persistent class for the ZY_BHJFYZ201608 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201608", schema="HIS")
@NamedQuery(name="ZyBhjfyz201608.findAll", query="SELECT z FROM ZyBhjfyz201608 z")
public class ZyBhjfyz201608 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 4945610037468456993L;
