...
/**
 * The persistent class for the ZY_BHJFYZ201604 database table.
 * 
 */
@Entity
@Table(name="ZY_BHJFYZ201604", schema="HIS")
@NamedQuery(name="ZyBhjfyz201604.findAll", query="SELECT z FROM ZyBhjfyz201604 z")
public class ZyBhjfyz201604 extends ZyBhjfyz implements Serializable {
	private static final long serialVersionUID = 5823308347500889848L;
