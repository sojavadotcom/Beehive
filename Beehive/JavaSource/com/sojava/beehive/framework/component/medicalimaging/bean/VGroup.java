...
@Subselect(
		...
		+ " left join medicalimaging.dic_coefficient tc on s.tech_coef_id=tc.id"
		+ " left join medicalimaging.dic_coefficient tac on s.tech_assist_coef_id=tac.id"
		+ " left join medicalimaging.dic_coefficient dc on s.diagno_coef_id=dc.id"
		+ " left join medicalimaging.dic_coefficient vc on s.verifier_coef_id=vc.id"
		+ " left join medicalimaging.dic_coefficient jc on s.job_coef_id=jc.id"
		+ " left join medicalimaging.dic_coefficient nc on s.nurse_coef_id=nc.id"
		+ " where "
