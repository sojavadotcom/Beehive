...
@Subselect(
		...
		+ " and a.execute_technician_staff_id=b.staff_id"
		+ "	and b.type='操作'"
		+ "	and b.kind='工作量'"
		+ "	union all "
		+ "	select "
		...
		+ "	and a.rbrvs_id=b.rbrvs_id"
		+ " and a.execute_technician_associate_staff_id=b.staff_id"
		+ "	and b.type='辅助'"
		+ "	and b.kind='工作量'"
		+ "	union all "
		+ "	select "
		...
		+ "	and a.rbrvs_id=b.rbrvs_id"
		+ " and a.execute_diagnostician_staff_id=b.staff_id"
		+ "	and b.type='阅片'"
		+ "	and b.kind='工作量'"
		+ "	and a.status='已审核'"
		+ "	union all "
		...
		+ "	and a.rbrvs_id=b.rbrvs_id"
		+ " and a.execute_verifier_staff_id=b.staff_id"
		+ "	and b.type='审片'"
		+ "	and b.kind='工作量'"
		+ "	and a.status='已审核'"
		+ ") a"
