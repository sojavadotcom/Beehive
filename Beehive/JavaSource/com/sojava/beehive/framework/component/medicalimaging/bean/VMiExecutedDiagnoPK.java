 ...
 */
@Embeddable
public class VMiExecutedDiagnoPK implements Serializable {
	private static final long serialVersionUID = -4276935797123961076L;
	...
	public VMiExecutedDiagnoPK() {
	}

	public VMiExecutedDiagnoPK(VMiExecutedDiagnoPK miExecutedPK) {
	}
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof VMiExecutedDiagnoPK)) {
			return false;
		}
		VMiExecutedDiagnoPK castOther = (VMiExecutedDiagnoPK)other;
		return 
